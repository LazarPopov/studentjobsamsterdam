...
// externalUrl: "https://www.uber.com/signup/drive/deliver/?invite_code=a6cpc37",
 ...
 {
    "slug": "rocycle-roform-instructor-amsterdam-20250403",
    "title": "Roform Instructor",
    "orgName": "Cycle Concepts Holding B.V.",
    "descriptionHtml": "<p>Your qualifications What are we looking for in you? - We love to see your energy come alive in the studio, that you have a love for celebrating your body through movement. - We look for minds that are curious, open-minded and with a growth mindset. - For humans who believe that self-love is the road to finding real joy in life and that the narrative of “summer bodies” should be left in the 90’s. We often attract those with a performance or sports background, but experience is not essential. - For those who take their work seriously; are on time, work well within a team and are reliable. - Have knowledge of anatomy and physiology. Pilates experience is a big plus. - Strong working and verbal communication proficiency in English (minimum B2 level CEFR or native equivalent). What does the training program look like? Our training program runs through 8 stages. In order to successfully complete training, you must demonstrate the necessary skills in each stage. Your instructing experience will determine how quickly you progress through the training. For experienced instructors, pilates or another fitness concept, you are more likely to progress through the training within 2 weeks. For those who are new to instructing, expect the training to run for 4 - 5 weeks. Every week In studio training sessions during the day from 13:00 - 16:00. Online learning modules, so you can learn at your own pace. We will facilitate classes for you to attend, so that you can learn from our coaching team to understand how the concept is taught. You will practice yourself in the studio, applying feedback you have received from the coaching team. With all of this taken into account, expect that training will take 15-20 hours per week. The training program is...</p>",
    "employmentType": "PART_TIME",
    "addressLocality": "Amsterdam",
    "addressRegion": "NH",
    "area": "Amsterdam Noord Roform",
    "englishFriendly": true,
    "DUO": true,
    "workHours": "Temporary",
    "datePosted": "2026-02-16",
    "categories": ["events"],
    "externalUrl": "https://rocycle.jobs.personio.com/job/2041352?language=en",
    ...
    {
    "slug": "rocycle-studio-manager-intern-rocycle-roform-amsterdam-amsterdam-20240716",
    "title": "Studio Manager Intern -  Rocycle & Roform Amsterdam",
    "orgName": "Cycle Concepts Holding B.V.",
    "descriptionHtml": "<p>Your qualifications Available for a minimum of 32 hours a week Excellent verbal communication skills in English What we offer you This internship is the place to combine your affinity with the health sector and your wish to gain more management experience whilst being part of a growing international fitness company. As a studio manager intern at Rocycle you will assist the studio manager in managing the operations team which consists of many varying tasks and responsibilities. For an internship of 32 hour a week, we offer a compensation of 400 euros a month and free Rocycle classes. Job description Description tasks: Help manage a team of 15-20 studio assistants, support and guide them when and where needed Help in hiring members of the operations team Organise and execute employee trainings Responsible for efficient scheduling of the operations team Think along in how the daily business can be improved (ex. customer service, employee satisfaction etc.) Help with maintaining the quality of the studios facilities Help with administrative tasks (monthly reports, forecasting, etc.) Ability to join management meetings and learn more in depth about the company</p>",
    "employmentType": "INTERN",
    "addressLocality": "Amsterdam",
    "addressRegion": "NH",
    "area": "Amsterdam City, Amsterdam Zuidas, Amsterdam de Pijp, Amsterdam Oost",
    "englishFriendly": true,
    "DUO": true,
    "workHours": "Intern / Student",
    "datePosted": "2026-02-16",
    "categories": ["hospitality"],
    "externalUrl": "https://rocycle.jobs.personio.com/job/1398033?language=en",
    "validThrough": "2026-04-16",
    "baseSalaryMin": 12.00,
    "baseSalaryMax": 16.00,
    "currency": "EUR",
    ...
    "englishFriendly": true,
    "DUO": true,
    "workHours": "Temporary, Part-time",
    "datePosted": "2026-02-16",
    "categories": ["events"],
    "externalUrl": "https://rocycle.job2025-04-03s.personio.com/job/2041352?language=en",
    "validThrough": "2026-04-16",
    "baseSalaryMin": 12.00,
    "baseSalaryMax": 16.00,
    "currency": "EUR",
...
import { NEW_JOBS } from "./newjobs_amsterdam";
