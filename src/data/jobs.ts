...
const NEW_JOBS: RawJob[] = [
  ...
  {
    slug: "thuisbezorgd-courier-Amsterdam",
    title: "Courier (Thuisbezorgd) Amsterdam",
    orgName: "Thuisbezorgd.nl",
    descriptionHtml:
      "<p>Pick up meals at restaurants and deliver them in Amsterdam. Choose your shifts in the app, get paid per hour including waiting time, plus tips and bonuses.</p>",
    employmentType: "PART_TIME",
    currency: "EUR",
    payUnit: "HOUR",
    addressLocality: "Amsterdam",
    workHours: "Self scheduled, weekday evening and one weekend evening availability expected",
    datePosted: new Date().toISOString().slice(0, 10),
    validThrough: "2026-12-31",
    categories: ["delivery"],
    externalUrl: "https://www.thuisbezorgd.nl/bezorger/amsterdam",
  },
  {
